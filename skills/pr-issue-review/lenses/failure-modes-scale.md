...
Good findings name the concrete scenario, explain why the current change would fall over, estimate severity by likely impact and likelihood, and suggest the smallest guard, fallback, bound, retry/idempotency change, partial-success handling, or observability improvement.
